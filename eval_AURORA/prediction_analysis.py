...
if __name__ == "__main__":
    labels_true = datasets.load_from_disk("../data/processed/scopus/base")['train']['label']
    labels_true = torch.tensor(labels_true)
    preds_mbert = pd.read_csv('predictions/predictions.csv')
    ...
    with open("predictions/metrics.csv", 'w', newline='') as csvfile:
